...
_gdcmswig.PUB_DICT_PATH_swigconstant(_gdcmswig)
PUB_DICT_PATH = _gdcmswig.PUB_DICT_PATH

_gdcmswig.GDCM_SOURCE_DIR_swigconstant(_gdcmswig)
GDCM_SOURCE_DIR = _gdcmswig.GDCM_SOURCE_DIR

_gdcmswig.GDCM_EXECUTABLE_OUTPUT_PATH_swigconstant(_gdcmswig)
GDCM_EXECUTABLE_OUTPUT_PATH = _gdcmswig.GDCM_EXECUTABLE_OUTPUT_PATH

_gdcmswig.GDCM_LIBRARY_OUTPUT_PATH_swigconstant(_gdcmswig)
GDCM_LIBRARY_OUTPUT_PATH = _gdcmswig.GDCM_LIBRARY_OUTPUT_PATH

_gdcmswig.OPENJPEG_MAJOR_VERSION_swigconstant(_gdcmswig)
OPENJPEG_MAJOR_VERSION = _gdcmswig.OPENJPEG_MAJOR_VERSION

_gdcmswig.GDCM_CMAKE_INSTALL_PREFIX_swigconstant(_gdcmswig)
GDCM_CMAKE_INSTALL_PREFIX = _gdcmswig.GDCM_CMAKE_INSTALL_PREFIX

_gdcmswig.GDCM_INSTALL_INCLUDE_DIR_swigconstant(_gdcmswig)
GDCM_INSTALL_INCLUDE_DIR = _gdcmswig.GDCM_INSTALL_INCLUDE_DIR

_gdcmswig.GDCM_INSTALL_DATA_DIR_swigconstant(_gdcmswig)
GDCM_INSTALL_DATA_DIR = _gdcmswig.GDCM_INSTALL_DATA_DIR

_gdcmswig.GDCM_PVRG_JPEG_EXECUTABLE_swigconstant(_gdcmswig)
GDCM_PVRG_JPEG_EXECUTABLE = _gdcmswig.GDCM_PVRG_JPEG_EXECUTABLE

_gdcmswig.GDCM_KAKADU_EXPAND_EXECUTABLE_swigconstant(_gdcmswig)
GDCM_KAKADU_EXPAND_EXECUTABLE = _gdcmswig.GDCM_KAKADU_EXPAND_EXECUTABLE

_gdcmswig.GDCM_MAJOR_VERSION_swigconstant(_gdcmswig)
GDCM_MAJOR_VERSION = _gdcmswig.GDCM_MAJOR_VERSION

_gdcmswig.GDCM_MINOR_VERSION_swigconstant(_gdcmswig)
GDCM_MINOR_VERSION = _gdcmswig.GDCM_MINOR_VERSION

_gdcmswig.GDCM_BUILD_VERSION_swigconstant(_gdcmswig)
GDCM_BUILD_VERSION = _gdcmswig.GDCM_BUILD_VERSION

_gdcmswig.GDCM_VERSION_swigconstant(_gdcmswig)
GDCM_VERSION = _gdcmswig.GDCM_VERSION

_gdcmswig.GDCM_API_VERSION_swigconstant(_gdcmswig)
...
def VM_GetNumberOfElementsFromArray(array: 'char const *', length: 'unsigned int') -> "unsigned int":
...
class StringFilter(_object):
    ...
    def FromString(self, *args) -> "std::string":
        """
        std::string
...
_gdcmswig.GDCM_FUNCTION_swigconstant(_gdcmswig)
...
class Testing(_object):
    ...
    __del__ = lambda self: None
    __swig_getmethods__["ComputeMD5"] = lambda x: _gdcmswig.Testing_ComputeMD5
    if _newclass:
    ...
    __swig_getmethods__["GetFileNames"] = lambda x: _gdcmswig.Testing_GetFileNames
    if _newclass:
        GetFileNames = staticmethod(_gdcmswig.Testing_GetFileNames)
    __swig_getmethods__["GetNumberOfFileNames"] = lambda x: _gdcmswig.Testing_GetNumberOfFileNames
    if _newclass:
        GetNumberOfFileNames = staticmethod(_gdcmswig.Testing_GetNumberOfFileNames)
    __swig_getmethods__["GetFileName"] = lambda x: _gdcmswig.Testing_GetFileName
    if _newclass:
        GetFileName = staticmethod(_gdcmswig.Testing_GetFileName)
    __swig_getmethods__["GetMediaStorageDataFiles"] = lambda x: _gdcmswig.Testing_GetMediaStorageDataFiles
    if _newclass:
        GetMediaStorageDataFiles = staticmethod(_gdcmswig.Testing_GetMediaStorageDataFiles)
    __swig_getmethods__["GetNumberOfMediaStorageDataFiles"] = lambda x: _gdcmswig.Testing_GetNumberOfMediaStorageDataFiles
    if _newclass:
        GetNumberOfMediaStorageDataFiles = staticmethod(_gdcmswig.Testing_GetNumberOfMediaStorageDataFiles)
    __swig_getmethods__["GetMediaStorageDataFile"] = lambda x: _gdcmswig.Testing_GetMediaStorageDataFile
    if _newclass:
        GetMediaStorageDataFile = staticmethod(_gdcmswig.Testing_GetMediaStorageDataFile)
    __swig_getmethods__["GetMediaStorageFromFile"] = lambda x: _gdcmswig.Testing_GetMediaStorageFromFile
    if _newclass:
        GetMediaStorageFromFile = staticmethod(_gdcmswig.Testing_GetMediaStorageFromFile)
    __swig_getmethods__["GetMD5DataImages"] = lambda x: _gdcmswig.Testing_GetMD5DataImages
    if _newclass:
        GetMD5DataImages = staticmethod(_gdcmswig.Testing_GetMD5DataImages)
    __swig_getmethods__["GetNumberOfMD5DataImages"] = lambda x: _gdcmswig.Testing_GetNumberOfMD5DataImages
    if _newclass:
        GetNumberOfMD5DataImages = staticmethod(_gdcmswig.Testing_GetNumberOfMD5DataImages)
    __swig_getmethods__["GetMD5DataImage"] = lambda x: _gdcmswig.Testing_GetMD5DataImage
    if _newclass:
        GetMD5DataImage = staticmethod(_gdcmswig.Testing_GetMD5DataImage)
    __swig_getmethods__["GetMD5FromFile"] = lambda x: _gdcmswig.Testing_GetMD5FromFile
    if _newclass:
        GetMD5FromFile = staticmethod(_gdcmswig.Testing_GetMD5FromFile)
    __swig_getmethods__["GetMD5FromBrokenFile"] = lambda x: _gdcmswig.Testing_GetMD5FromBrokenFile
    if _newclass:
        GetMD5FromBrokenFile = staticmethod(_gdcmswig.Testing_GetMD5FromBrokenFile)
    __swig_getmethods__["GetStreamOffsetFromFile"] = lambda x: _gdcmswig.Testing_GetStreamOffsetFromFile
    if _newclass:
        GetStreamOffsetFromFile = staticmethod(_gdcmswig.Testing_GetStreamOffsetFromFile)
    __swig_getmethods__["GetSelectedTagsOffsetFromFile"] = lambda x: _gdcmswig.Testing_GetSelectedTagsOffsetFromFile
    if _newclass:
        GetSelectedTagsOffsetFromFile = staticmethod(_gdcmswig.Testing_GetSelectedTagsOffsetFromFile)
    __swig_getmethods__["GetSelectedPrivateGroupOffsetFromFile"] = lambda x: _gdcmswig.Testing_GetSelectedPrivateGroupOffsetFromFile
    if _newclass:
        GetSelectedPrivateGroupOffsetFromFile = staticmethod(_gdcmswig.Testing_GetSelectedPrivateGroupOffsetFromFile)
    __swig_getmethods__["GetLossyFlagFromFile"] = lambda x: _gdcmswig.Testing_GetLossyFlagFromFile
    if _newclass:
        GetLossyFlagFromFile = staticmethod(_gdcmswig.Testing_GetLossyFlagFromFile)
    __swig_getmethods__["GetDataRoot"] = lambda x: _gdcmswig.Testing_GetDataRoot
    if _newclass:
        GetDataRoot = staticmethod(_gdcmswig.Testing_GetDataRoot)
    __swig_getmethods__["GetDataExtraRoot"] = lambda x: _gdcmswig.Testing_GetDataExtraRoot
    if _newclass:
        GetDataExtraRoot = staticmethod(_gdcmswig.Testing_GetDataExtraRoot)
    __swig_getmethods__["GetPixelSpacingDataRoot"] = lambda x: _gdcmswig.Testing_GetPixelSpacingDataRoot
    if _newclass:
        GetPixelSpacingDataRoot = staticmethod(_gdcmswig.Testing_GetPixelSpacingDataRoot)
    __swig_getmethods__["GetTempDirectory"] = lambda x: _gdcmswig.Testing_GetTempDirectory
    if _newclass:
        GetTempDirectory = staticmethod(_gdcmswig.Testing_GetTempDirectory)
    __swig_getmethods__["GetTempDirectoryW"] = lambda x: _gdcmswig.Testing_GetTempDirectoryW
    if _newclass:
        GetTempDirectoryW = staticmethod(_gdcmswig.Testing_GetTempDirectoryW)
    __swig_getmethods__["GetTempFilename"] = lambda x: _gdcmswig.Testing_GetTempFilename
    if _newclass:
        GetTempFilename = staticmethod(_gdcmswig.Testing_GetTempFilename)
    __swig_getmethods__["GetTempFilenameW"] = lambda x: _gdcmswig.Testing_GetTempFilenameW
    if _newclass:
        GetTempFilenameW = staticmethod(_gdcmswig.Testing_GetTempFilenameW)
    __swig_getmethods__["GetSourceDirectory"] = lambda x: _gdcmswig.Testing_GetSourceDirectory
    if _newclass:
        GetSourceDirectory = staticmethod(_gdcmswig.Testing_GetSourceDirectory)
    __swig_getmethods__["ComputeFileMD5"] = lambda x: _gdcmswig.Testing_ComputeFileMD5
    if _newclass:
...
def Testing_ComputeMD5(buffer: 'char const *', buf_len: 'unsigned long', digest_str: 'char [33]') -> "bool":
...
def MD5_Compute(buffer: 'char const *', buf_len: 'unsigned long', digest_str: 'char [33]') -> "bool":
...
_gdcmswig.ePatientRootType_swigconstant(_gdcmswig)
ePatientRootType = _gdcmswig.ePatientRootType

_gdcmswig.eStudyRootType_swigconstant(_gdcmswig)
...
_gdcmswig.ePatient_swigconstant(_gdcmswig)
ePatient = _gdcmswig.ePatient

_gdcmswig.eStudy_swigconstant(_gdcmswig)
eStudy = _gdcmswig.eStudy

_gdcmswig.eSeries_swigconstant(_gdcmswig)
eSeries = _gdcmswig.eSeries

_gdcmswig.eImage_swigconstant(_gdcmswig)
eImage = _gdcmswig.eImage

_gdcmswig.eFind_swigconstant(_gdcmswig)
eFind = _gdcmswig.eFind

_gdcmswig.eMove_swigconstant(_gdcmswig)
eMove = _gdcmswig.eMove

_gdcmswig.eWLMFind_swigconstant(_gdcmswig)
...
_gdcmswig.eLatin1_swigconstant(_gdcmswig)
eLatin1 = _gdcmswig.eLatin1

_gdcmswig.eLatin2_swigconstant(_gdcmswig)
eLatin2 = _gdcmswig.eLatin2

_gdcmswig.eLatin3_swigconstant(_gdcmswig)
eLatin3 = _gdcmswig.eLatin3

_gdcmswig.eLatin4_swigconstant(_gdcmswig)
eLatin4 = _gdcmswig.eLatin4

_gdcmswig.eCyrillic_swigconstant(_gdcmswig)
eCyrillic = _gdcmswig.eCyrillic

_gdcmswig.eArabic_swigconstant(_gdcmswig)
eArabic = _gdcmswig.eArabic

_gdcmswig.eGreek_swigconstant(_gdcmswig)
eGreek = _gdcmswig.eGreek

_gdcmswig.eHebrew_swigconstant(_gdcmswig)
eHebrew = _gdcmswig.eHebrew

_gdcmswig.eLatin5_swigconstant(_gdcmswig)
eLatin5 = _gdcmswig.eLatin5

_gdcmswig.eJapanese_swigconstant(_gdcmswig)
eJapanese = _gdcmswig.eJapanese

_gdcmswig.eThai_swigconstant(_gdcmswig)
eThai = _gdcmswig.eThai

_gdcmswig.eJapaneseKanjiMultibyte_swigconstant(_gdcmswig)
eJapaneseKanjiMultibyte = _gdcmswig.eJapaneseKanjiMultibyte

_gdcmswig.eJapaneseSupplementaryKanjiMultibyte_swigconstant(_gdcmswig)
eJapaneseSupplementaryKanjiMultibyte = _gdcmswig.eJapaneseSupplementaryKanjiMultibyte

_gdcmswig.eKoreanHangulHanjaMultibyte_swigconstant(_gdcmswig)
eKoreanHangulHanjaMultibyte = _gdcmswig.eKoreanHangulHanjaMultibyte

_gdcmswig.eUTF8_swigconstant(_gdcmswig)
eUTF8 = _gdcmswig.eUTF8

_gdcmswig.eGB18030_swigconstant(_gdcmswig)
